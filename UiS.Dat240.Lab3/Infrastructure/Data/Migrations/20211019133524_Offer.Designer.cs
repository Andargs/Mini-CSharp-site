...
namespace UiS.Dat240.Lab3.Migrations
{
    ...
    [Migration("20211019133524_Offer")]
    partial class Offer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UiS.Dat240.Lab3.Core.Domain.Fullfillment.Offer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("UiS.Dat240.Lab3.Core.Domain.Fullfillment.Reimbursement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("UiS.Dat240.Lab3.Core.Domain.Fullfillment.Shipper", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("UiS.Dat240.Lab3.Core.Domain.Fullfillment.Offer", b =>
                {
                    b.HasOne("UiS.Dat240.Lab3.Core.Domain.Fullfillment.Reimbursement", "Reimbursement")
                        .WithMany()
                        .HasForeignKey("ReimbursementId");

                    b.HasOne("UiS.Dat240.Lab3.Core.Domain.Fullfillment.Shipper", "Shipper")
                        .WithMany()
